...
Below outlines a possible scenario where you might find these commands useful.
...
image::RecipeCommand4.png[width=382]
...
You are now ready to use the recipe commands to modify your recipes in Cooking Papa!
//end::gohkh[]
...
Note: Ingredient names added are case-insensitive.
...
This command allows Cooking Papa to recommend a recipe for you when you do not have any idea on what to cook.

Note: This command will only generate recipes that are currently in the cookbook.
